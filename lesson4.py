...
# # }
#
# # Заполнить список четными числами от А до Б (вводятся с клавиатуры)
#
# # a = int(input('a: '))
# # b = int(input('b: '))
# # numbers = [i for i in range(a, b+1, 2)]
#
# # сформировать словарь на основании списка ключей и списка значений
# keys = ('name', 'age', 'city')
# values = ('alex', 43, 'minsk')
#
